...
<footer id="footer">
    <div class="container">
        <div id="footer-menu" class="row">
            <ul class="clearfix">
                <li><a href="/"><span><i class="fa fa-play-circle-o"></i><span><?php echo t('Home'); ?></span></span></a></li>
                <li><a href="/actu"><span><i class="fa fa-play-circle-o"></i><span><?php echo t('Actu'); ?></span></span></a></li>
